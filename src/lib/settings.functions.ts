    ...
    await getDb().execute({
      sql: `INSERT INTO site_settings (id, name, role, tagline, contact_email, linkedin_url, github_url)
            ...
            ON CONFLICT(id) DO UPDATE SET
              ...
              contact_email=excluded.contact_email, linkedin_url=excluded.linkedin_url,
              github_url=excluded.github_url`,
      args: [data.name, data.role, data.tagline, data.contact_email, data.linkedin_url, data.github_url],
    });
